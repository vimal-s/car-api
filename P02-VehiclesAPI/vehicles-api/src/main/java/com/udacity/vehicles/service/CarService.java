...
public class CarService {
    ...
    public Car findById(Long id) throws Throwable {
        ...
        Car car1 = optionalCar.orElseThrow((Supplier<Throwable>) CarNotFoundException::new);
        /**
         ...
         */
        Location updatedLocation = mapsClient.getAddress(car1.getLocation());
        car1.setLocation(updatedLocation);
        return car1;
    }
